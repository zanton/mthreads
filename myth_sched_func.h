...
MYTH_CTX_CALLBACK void myth_create_1(void *arg1,void *arg2,void *arg3)
{
	...
	profiler_add_time_start(new_thread, env->rank, 3);
#endif /*PROFILER_ON*/
  ...
  void *arg, size_t stack_size)
{
	...
	profiler_add_time_stop(env->this_thread, env->rank, 10);
#endif /*PROFILER_ON*/
  ...
  // Initialize thread descriptor
	...
	new_thread->node = (profiler_libins_task_node_t) profiler_create_new_node(this_thread->node);
#endif /*PROFILER_ON*/
...
MYTH_CTX_CALLBACK void myth_yield_1(void *arg1,void *arg2,void *arg3)
{
	...
	profiler_add_time_start(next_thread, env->rank, 4);
#endif /*PROFILER_ON*/
...
MYTH_CTX_CALLBACK void myth_yield2_1(void *arg1,void *arg2,void *arg3)
{
	...
	profiler_add_time_start(next_thread, env->rank, 5);
#endif /*PROFILER_ON*/
...
static inline void myth_yield2_body(void)
{
	...
	profiler_add_time_stop(th, env->rank, 11);
#endif /*PROFILER_ON*/
...
static inline void myth_join_1(myth_running_env_t e,myth_thread_t th,void **result)
{
	...
	profiler_add_time_start(e->this_thread, e->rank, 6);
#endif /*PROFILER_ON*/
...
MYTH_CTX_CALLBACK void myth_join_2(void *arg1,void *arg2,void *arg3)
{
	...
	profiler_add_time_start(next_thread, env->rank, 7);
#endif /*PROFILER_ON*/
...
static inline void myth_join_body(myth_thread_t th,void **result)
{
	...
	profiler_add_time_stop(this_thread, env->rank, 12);
#endif /*PROFILER_ON*/
...
MYTH_CTX_CALLBACK void myth_entry_point_1(void *arg1,void *arg2,void *arg3)
{
	...
	profiler_add_time_start(next_thread, env->rank, 8);
#endif /*PROFILER_ON*/
}
