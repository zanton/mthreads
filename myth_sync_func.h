...
MYTH_CTX_CALLBACK void myth_barrier_wait_1(void *arg1,void *arg2,void *arg3)
{
	...
	profiler_add_time_start(next, env->rank, 9);
#endif /*PROFILER_ON*/
}
...
static inline void myth_jc_wait_body(myth_jc_t jc)
{
	if (jc->count<=0){
		...
		profiler_add_time_stop(this_thread, env->rank, 15);
#endif /*PROFILER_ON*/
...
static inline int myth_felock_lock_body(myth_felock_t fe)
{
	...
	myth_running_env_t env;
	env = myth_get_current_env();
	profiler_add_time_stop(env->this_thread, env->rank, 16);
#endif /*PROFILER_ON*/
...
MYTH_CTX_CALLBACK void myth_felock_wait_lock_1(void *arg1,void *arg2,void *arg3)
{
	...
	if (next)
		profiler_add_time_start(next, env->rank, 11);
#endif /*PROFILER_ON*/
}
...
static inline int myth_felock_wait_lock_body(myth_felock_t fe,int val)
{
	...
	profiler_add_time_stop(this_thread, e->rank, 16);
#endif /*PROFILER_ON*/
	...
	while (1){
		...
		if ((!!val)==(!!fe->fe)){
			...
			profiler_add_time_start(this_thread, env->rank, 12);
#endif /*PROFILER_ON*/
...
MYTH_CTX_CALLBACK void myth_cond_wait_1(void *arg1,void *arg2,void *arg3)
{
	...
	if (next)
		profiler_add_time_start(next, env->rank, 14);
#endif /*PROFILER_ON*/
}
...
static inline int myth_cond_wait_body(myth_cond_t cond,myth_mutex_t mtx)
{
	...
	profiler_add_time_stop(this_thread, env->rank, 17);
#endif /*PROFILER_ON*/
